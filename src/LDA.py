...
Example:    
    ...
    with self-chosen parameters:
        $ python LDA.py -input ../data/FRIENDS_TV_script -n_top 5 -t 150
...
def main():
    ...
    # convert a list of all the scripts to a list of strings and then join its elements (it is needed for aplying the function below)
    ...
    # filter out frequent words without much semantic meaning
